Terraform module which creating ALB and set an ALB listener on Alibaba Cloud

terraform-alicloud-logstore-alb-listener
=====================================================================

English | [简体中文](README-CN.md)

This module is used to create ALB and set an alb listener on Alibaba Cloud under Alibaba Cloud.
...
* [alicloud_alb_server_group](https://registry.terraform.io/providers/aliyun/alicloud/latest/docs/resources/alb_load_balancer)
...
module "example" {
  source       = "terraform-alicloud-modules/logstore-alb-listener/alicloud"
  vpc_id       = "vpc-ajwizkaizk1ka"
  vswtich_id_1 = "vsw-id1"
  vswtich_id_2 = "vsw-id2"
